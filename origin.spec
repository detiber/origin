...
%{!?commit:
%global commit 49a4a7a9446c68ebdd771c37dcf72a2b09338487
}
%global shortcommit %(c=%{commit}; echo ${c:0:7})
# os_git_vars needed to run hack scripts during rpm builds
%{!?os_git_vars:
%global os_git_vars OS_GIT_COMMIT=49a4a7a OS_GIT_MINOR=5+ OS_GIT_MAJOR=1 OS_GIT_TREE_STATE=clean OS_GIT_VERSION=v1.5.0-rc.0+49a4a7a
}
