...
%{!?commit:
%global commit be0de4d0467b2bf33d3a27fbf639885d0787a73f
}
%global shortcommit %(c=%{commit}; echo ${c:0:7})
# os_git_vars needed to run hack scripts during rpm builds
%{!?os_git_vars:
%global os_git_vars OS_GIT_COMMIT=be0de4d OS_GIT_MINOR=6+ OS_GIT_VERSION=v3.6.0-alpha.1+be0de4d-776 OS_GIT_TREE_STATE=clean OS_GIT_MAJOR=3
}
